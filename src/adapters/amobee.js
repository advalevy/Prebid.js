...
var AmobeeAdapter = function AmobeeAdapter() {
  ...
  function _createRequestContent(bid) {
 		...
 		//var domain = bid.params.amobeeDomain || 'http://rrmprod.amobee.com';
 		var domain = bid.params.amobeeDomain || 'http://qa-ads.integration.amobee.com'; ////for tests!!!
        ...
        //content += '<scr' + 'ipt type="text/javascript" src="http://localhost:9999/amobeejstag/tag-full.js"></scr' + 'ipt>';
...
$$PREBID_GLOBAL$$.handleAmobeeAdCallback = function (adReceived, adRequest, adResponseHeaders, headerBiddingResponse, bidId) {
	...
	console.log("bidObj.bidId = " + bidId); ///shirel for testing
	if (bidObj) console.log("bidObj.placementCode = " + bidObj.placementCode); ///shirel for testing
    console.log("bidObject: " + JSON.stringify(bidObject)); ///benzi for testing
